  ...
  return (
    ...
    >
      <div className="bg-primary-400 rounded-xl flex flex-col py-5">
        ...
        <p className="mx-auto mt-4 text-yellow-200">Are you sure you want to delete this chat?</p>
        <div className="flex flex-col xs:grid xs:grid-cols-2 mt-6 ">
            <button className="xs:block w-3/5 mx-auto xs:ms-auto xs:me-1 py-1 bg-black hover:bg-gray-800 text-primary-400 rounded-lg" onClick={() => setDeleting(false)}>Close</button>
